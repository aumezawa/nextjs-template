            ...
            labels.map((label: string, index: number) => (
              ...
              >
                <button
                  ...
                  type="button"
                  role="tab"
                  className="inline-block p-4 text-sm font-medium text-center border-b-2 rounded-t-lg cursor-auto hover:text-gray-600 hover:border-gray-300 aria-selected:text-blue-600 aria-selected:border-blue-600"
